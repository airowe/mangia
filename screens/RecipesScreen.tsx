...
export const RecipesScreen = () => {
  ...
  const handleLoadMoreUserRecipes = useCallback(() => {
    ...
    userRecipesPagination.isFetching,
    userRecipesPagination.hasMore,
    loadUserRecipes,
  ]);
  ...
  const handleLoadMoreAllRecipes = useCallback(() => {
    ...
    allRecipesPagination.isFetching,
  ...
  const handleScroll = useCallback(
    (event: NativeSyntheticEvent<NativeScrollEvent>, tabIndex: number) => {
      ...
      >
        ...
        {featuredRecipe && !loading.user && (
          <Animated.View
            ...
            style={dynamicStyles.featuredSection}
          >
