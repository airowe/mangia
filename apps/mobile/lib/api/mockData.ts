...
MOCK_RECIPES.push(
  {
    ...
    ingredients: [
      { id: 'mock-ing-4-0', recipe_id: 'mock-recipe-4', name: '00 flour', quantity: 500, unit: 'g', category: 'pantry' },
      { id: 'mock-ing-4-1', recipe_id: 'mock-recipe-4', name: 'Water', quantity: 325, unit: 'ml', category: 'other' },
      { id: 'mock-ing-4-2', recipe_id: 'mock-recipe-4', name: 'Active dry yeast', quantity: 1, unit: 'tsp', category: 'pantry' },
      { id: 'mock-ing-4-3', recipe_id: 'mock-recipe-4', name: 'San Marzano tomatoes', quantity: 1, unit: 'can', category: 'pantry' },
      { id: 'mock-ing-4-4', recipe_id: 'mock-recipe-4', name: 'Fresh mozzarella', quantity: 8, unit: 'oz', category: 'dairy_eggs' },
      { id: 'mock-ing-4-5', recipe_id: 'mock-recipe-4', name: 'Fresh basil', quantity: 10, unit: 'leaves', category: 'produce' },
      { id: 'mock-ing-4-6', recipe_id: 'mock-recipe-4', name: 'Extra virgin olive oil', quantity: 2, unit: 'tbsp', category: 'pantry' },
    ],
  },
  {
    id: `mock-recipe-${mockRecipeIdCounter++}`,
    ...
    ingredients: [
      { id: 'mock-ing-5-0', recipe_id: 'mock-recipe-5', name: 'Green curry paste', quantity: 3, unit: 'tbsp', category: 'pantry' },
      { id: 'mock-ing-5-1', recipe_id: 'mock-recipe-5', name: 'Coconut milk', quantity: 2, unit: 'cans', category: 'pantry' },
      { id: 'mock-ing-5-2', recipe_id: 'mock-recipe-5', name: 'Chicken breast', quantity: 1, unit: 'lb', category: 'meat_seafood' },
      { id: 'mock-ing-5-3', recipe_id: 'mock-recipe-5', name: 'Thai eggplant', quantity: 1, unit: 'cup', category: 'produce' },
      { id: 'mock-ing-5-4', recipe_id: 'mock-recipe-5', name: 'Bamboo shoots', quantity: 0.5, unit: 'cup', category: 'pantry' },
      { id: 'mock-ing-5-5', recipe_id: 'mock-recipe-5', name: 'Fish sauce', quantity: 2, unit: 'tbsp', category: 'pantry' },
      { id: 'mock-ing-5-6', recipe_id: 'mock-recipe-5', name: 'Thai basil', quantity: 0.5, unit: 'cup', category: 'produce' },
    ],
  }
);
